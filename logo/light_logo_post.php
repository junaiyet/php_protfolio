...
// $title = $_POST['title'];
$uploded_file = $_FILES['light_logo'];
...
if (in_array($extension,$allowed_extension)) {
    if ($uploded_file['size'] <= 1000000) {
        ...
        $inssert = "INSERT INTO  light_logos(light_logo) VALUES ('$uploded_file_name')";
        ...
        // 
        $update_users = "UPDATE light_logos SET light_logo = '$file_name' WHERE id=$last_id";
