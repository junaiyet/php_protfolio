                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="card">
                               ...
                               <div class="card-body">
                               <div class="icon" style="background:#f5f5f5; height:350px;padding:15px;overflow:scroll;cursor:pointer; font-size:25px;">
                                   ...
                                   <div class="mt-3 pos-lg-relative">
                                            <label for="form-label">Service Icon</label>
                                            <input type="text" style="color:transparent;" class="form-control" id="icon_input" name="counter_icon">
