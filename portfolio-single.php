...
$select_work = "SELECT * FROM works_area WHERE id=$id";
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uplodeds/works/<?=$after_assoc['image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$after_assoc['title']?></h2>
                                    <p>
                                    <?=$after_assoc['description']?>
                                    </p>
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                <a href="https://www.facebook.com/sharer/sharer.php?id=<?=$id?>"><i class="fab fa-facebook-f"></i></a>
                                                <a href="#"><i class="fab fa-twitter"></i></a>
                                ...
                                <?php 
                                                ...
                                                $after_assoc2 = mysqli_fetch_assoc($user_result);
                                              
                                              ?>
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="uplodeds/users/<?=$after_assoc2['profile_photo']?>" alt="img">
                                            </div>
